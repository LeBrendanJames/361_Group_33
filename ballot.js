...
console.log(ballot.getVotingItemByNum(0));
console.log(ballot.getVotingItemByNum(1));
 
console.log("Before choice: " + (ballot.getVotingItemByNum(0)).choice);
ballot.makeChoice(0, 1);
console.log("After Choice: " + (ballot.getVotingItemByNum(0)).choice);
console.log(ballot.getAllVotingItems());